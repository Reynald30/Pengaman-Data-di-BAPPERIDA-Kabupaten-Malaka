...
<h1 class="page-header">Data Audio Dan Video Terenkripsi</h1>
<?php include('_partials/menu.php') ?>

<?php
include '../../config/koneksi.php';

$sql = "SELECT * FROM enkripsi_av";
$result = $db->query($sql);
?>
  ...
  <tbody>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<li><a href='lihat.php?id=" . $row['id_en'] . "' class='btn btn-info btn-xs'><span class='glyphicon glyphicon-eye-open'></span> Lihat</a></li><li class='divider'></li>"; // Tambahkan tombol lihat dengan mengarahkan ke file lihat.php
            if ($_SESSION['user']['status_user'] != 'Petugas') { 
            echo "<li><a href='hapus.php?id=" . $row['id_en'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus file ini?\")'><span class='glyphicon glyphicon-trash'></span> Hapus</a></li><li class='divider'></li>"; // Tambahkan tombol hapus dengan mengarahkan ke file hapus.php
             }

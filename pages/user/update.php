...
if ($_POST['password_user'] == '') {
  ...
  $query = "UPDATE user SET nama_user = '$nama_user', username_user = '$username_user',  status_user = '$status_user', email = '$email', tempat = '$tempat' WHERE user.id_user = $id_user;";
} else {
  // jika ubah password

  $query = "UPDATE user SET nama_user = '$nama_user', username_user = '$username_user', password_user = '$password_user',  status_user = '$status_user',email = '$email', tempat = '$tempat' WHERE user.id_user = $id_user;";
}

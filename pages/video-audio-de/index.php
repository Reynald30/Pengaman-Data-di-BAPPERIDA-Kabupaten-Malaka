...
<h1 class="page-header">Data Audio Dan Video Terdekripsi</h1>
  ...
  <tbody>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<li><a href='lihat.php?id=" . $row['id_de'] . "' class='btn btn-info btn-xs'><span class='glyphicon glyphicon-eye-open'></span> Lihat</a></li>  <li class='divider'></li>"; // Tambahkan tombol lihat dengan mengarahkan ke file lihat.php
